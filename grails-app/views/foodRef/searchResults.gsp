                ...
                <table>
                    ...
                    <g:each in="${foodList}" status="i" var="food">
                        <tr class="${(i % 2) == 0 ? 'odd' : 'even'}">
                            ...
                            <td><g:link controller="food" action="show" id="${food.id}">${food.id?.encodeAsHTML()}</g:link></td>
                                                   
                            <td><g:link controller="food" action="show" id="${food.id}">${food.name?.encodeAsHTML()}</g:link></td>
                            
                            <td>${food.description?.encodeAsHTML()}</td>
